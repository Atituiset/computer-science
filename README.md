...
| – | **工程化实践轴 · 让代码跑进生产** | [`engineering/`](engineering/README.md) | 8 / 2.3K |
...
合计：**导论卷 + 工程化实践轴 + 第零部分（前置数学）+ 13 主题部分**，~260 个 `.md` / ~52.6K 行 / ~62 个一线章节。
...
- 工程化实践轴可选增补：GitHub Actions 实战、云原生发布（K8s GitOps 实操）、SRE 工程。
